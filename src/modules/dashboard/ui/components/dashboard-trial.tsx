...
import {
  MAX_FREE_AGENTS,
  MAX_FREE_MEETINGS,
} from "@/modules/premium/server/contants";
...
export const DashboardTrial = () => {
  ...
  return (
    <div
      className="border border-borde/10 rounded-lg w-full 
  bg-white/5 flex flex-col gap-y-2"
    >
      <div className="p-3 flex-col gap-y-4">
